...
|---|---|---|---|---|
| controls-009 | Clutch | DRAFT | DRAFT | Decide consistent AF clutch term; XH technical term requires human review |
| controls-010 | Gear lever | DRAFT | DRAFT | Check rathefboom / learner-friendly AF term; XH requires human review |
| controls-011 | Indicator switch | DRAFT | DRAFT | Keep signalling meaning clear; align with current indicator terminology |
| controls-012 | Mirrors | DRAFT | DRAFT | Distinguish mirror/component from abstract “rear-view” wording |
