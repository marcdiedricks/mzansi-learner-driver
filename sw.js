const CACHE="mzansi-learner-driver-v0.1c-r1";
const ASSETS=["./","./index.html","./style.css","./i18n.js","./app.js","./manifest.json","./icons/mzansi-learner.svg","./data/questions/rules.json","./data/questions/signs.json","./data/questions/controls.json"];
